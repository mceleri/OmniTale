...
export interface StoryState {
  ...
  createStory: (title: string, synopsis: string, characterName: string, genre: string, type?: 'tale' | 'template') => void;
...
export const useStoryStore = create<StoryState>()(
  persist(
    (set: any) => ({
      ...
      createStory: (title: string, synopsis: string, characterName: string, genre: string, type: 'tale' | 'template' = 'tale') => set((state: StoryState) => {
